...
class AlbumViewTest < ActionDispatch::IntegrationTest
  ...
  def test_get_download_fails_if_release_without_file
    @release.remove_file!
    @release.save
    refute @release.file?
  ...
  def test_get_download_succeeds_if_release_in_provided_format_exists
    assert_equal 0, @release.downloads
  ...
  def test_get_download_succeeds_with_purchase_code_if_release_for_sale
  ...
  def test_get_download_fails_without_purchase_if_release_for_sale
    @release.update(for_sale: true, price: 20.0, currency: 'USD')
  ...
  def test_get_download_fails_without_purchase_code_if_release_for_sale
    @release.update(for_sale: true, price: 20.0, currency: 'USD')
  ...
  def test_get_download_fails_when_download_limit_exceeded
    @release.update(for_sale: true, price: 20.0, currency: 'USD')
